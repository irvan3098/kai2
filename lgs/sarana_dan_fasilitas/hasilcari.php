    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
            	<li>
                	<a href="index.php">Sarana dan fasilitas</a>
                    <li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                       <li>
                            <a href="#"><i class="fa fa-sitemap fa-fw"></i> Sarana dan fasilitas<span class="fa arrow"></span></a>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-8">
                        <h1 class="page-header">Data sarana dan fasilitas</h1>
                    </div>
                    <div class="col-lg-4">
                        <br>
...
data</a>
                                ...
                                <li><a href="#judul" data-toggle="tab">Nama kontrak</a>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="tambahdata">
                                   <div class="col-lg-5">
                                    <form name="sarfas" method="post" enctype="multipart/form-data">	
                                    	<div class="panel-body">
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form name="tjudul" method="post" enctype="multipart/form-data">
                                                                        <table class="table">
                                                                                <tr>
                                                                                     <td><label>Judul</label></td>
                                                                                     <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td><label>File kontrak</label></td>
                                                                                    <td>
                                                                                        <div class="form-group">
                             ...
                             <i class="fa fa-plus"></i>
                                        ...
                                        <tr>
                                    		...
                                    		<td>
                                                <div class="form-group">
                                                <input class="form-control" type="text" name="nosap">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                    		...
                                    		<td>
                                                <div class="form-group ">
                                                <input class="form-control" type="text" name="spesifikasi">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                                    ...
                                                    <div class="modal fade" id="myModal4a" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                     <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
                                                                    <button type="submit" class="btn btn-primary" name="tambahmatauang">Tambah</button>
                                                                    <?php tambah_matauang();?>
                                                                    </form>
                                                                </div>
                                                            </div>
                                        ...
                                        <tr>
                                    		...
                                    		<td>
                                               ...
                                               <select class="form-control" name="vendor">
                                                ...
                                                <span class="input-group-btn">
                                                   <a class="btn btn-warning" data-toggle="modal" data-target="#myModal5" data-placement="top" title="Tambah satuan">
                             <i class="fa fa-plus"></i>
                                                    </a>
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="myModal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form name="tvendor" method="post">
                                                                        <table class="table">
                                                                                <tr>
                                                                                     <td>
                                                                            		<input class="form-control" type="text" name="tvendor" />
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                </div>
                                                                <div class="modal-footer">
                                                                     <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
                                                                    <button type="submit" class="btn btn-primary" name="tambahvendor">Tambah</button>
                                                                    <?php tambah_vendor(); ?>
                                                                    </form>
                                                                </div>
                                                            </div>
                                ...
                                <div class="tab-pane fade" id="cetak">
                                    ...
                                    <div class="col-lg-6">
                                         <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered table-hover table-striped" id="cetak_beberapa">
                                                       <thead>
                                                            <tr>
                                                                <td>No</td>
                                                                <td>Nama judul</td>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <!-- Nav tabs -->
                            <ul class="nav nav-tabs">
                                <li><a href="#satuan" data-toggle="tab">satuan</a>
                                </li>
                                <li><a href="#matauang" data-toggle="tab">mata uang</a>
                                </li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="vendor">
                                    <h4></h4>
                                    <p>
                                    	<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example-datavendor">
                                                <thead>
                                                    <tr>
                                                        <th>NO</th>
                                                        <th>VENDOR</th>
                ...
                </div><!--cols 12 data list-->
                </div><!--cols 12 pengelolaan data-->
