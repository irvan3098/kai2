				...
				<section id="main" class="container">
					...
					<section class="box special">
						...
						<header class="major">
                            ...
                            <h4>Sumber dari : <?php echo $_GET["sumber"];?></h4>
							<p>
                                    Untuk cetak klick icon ini
                                    <a href="#" onClick="window.open('http://<?php url();?>user/umum/detail_cetak.php?id=<?php echo $_GET["id"];; ?>&judul=<?php echo $_GET["judul"];?>','popuppage','width=500,toolbar=0,resizable=0,scrollbars=no,height=400,top=100,left=100');">
