				...
				<header id="header" class="alt">
					...
					<nav id="nav">
						<ul>
                            ...
                            <li>
                            	<a href="index.php" class="icon fa-angle-down">Pekerjaan</a>
                            	<?php menu_pekerjaan();?>
                            </li>
					...
					<section class="box special">
                       <span class="image featured">
						...
						<header class="major">
							...
							<h3>Data harga satuan <strong><em><?php echo $_GET["judul"];?></em></strong></h3>
							<p>
                                    Untuk cetak klick icon ini
                                    <a href="#" onClick="window.open('http://<?php url();?>/user/pekerjaan/detail_cetak.php?id=<?php echo $_GET["id"];; ?>&judul=<?php echo $_GET["judul"];?>','popuppage','width=500,toolbar=0,resizable=0,scrollbars=no,height=400,top=100,left=100');">
                                    <i class=" fa fa-2x fa-print"></i>
                                    </a>
                                </p>
                            <div class="12u">
								<table width="100%" class="table align-left" id="dataTables-example">
                                    <thead>
                                    <tr>
                                    <th>NO</th>
                                    <th>KODE</th>
                                    <th>SATUAN</th>
                                    <th>HARGA SATUAN PEKERJAAN <?php echo $_GET["judul"];?></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php ditail_data();?>
