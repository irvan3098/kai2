					...
					<section class="box special">
						...
						<header class="major">
							...
							<p>
                                    ...
                                    <a href="#" onClick="window.open('http://<?php url();?>user/sarfas/cetak_hascar.php?id=<?php echo $_GET["id"];; ?>&judul=<?php echo $_GET["judul"];?>','popuppage','width=500,toolbar=0,resizable=0,scrollbars=no,height=400,top=100,left=100');">
